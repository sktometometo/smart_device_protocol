...
std::optional<String> operation_sesami(String device_uuid, String api_key,
                                       int command, String secret_key);
...
std::optional<String> operation_sesami(String device_uuid, String api_key,
  ...
  String body = String("{\"cmd\":") + command + String(",\"sign\":\"") + sign +

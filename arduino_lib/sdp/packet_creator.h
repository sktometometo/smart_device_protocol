...
void generate_meta_frame(uint8_t *packet, const char *device_name,
                         const char *packet_description_01,
                         const char *serialization_format_01,
                         const char *packet_description_02,
  ...
  *(uint16_t *)(packet + 0) = smart_device_protocol::Packet::PACKET_TYPE_META;
  ...
  strncpy((char *)(packet + 2 + 20 + 64 + 10 + 64), serialization_format_02,
          10);
  strncpy((char *)(packet + 2 + 20 + 64 + 10 + 64 + 10), packet_description_03,
          64);
  strncpy((char *)(packet + 2 + 20 + 64 + 10 + 64 + 10 + 64),
...
void create_device_message_board_data_packet(uint8_t *packet,

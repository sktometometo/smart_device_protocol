#ifndef _ROS_fetch_auto_dock_msgs_UndockFeedback_h
#define _ROS_fetch_auto_dock_msgs_UndockFeedback_h
...
namespace fetch_auto_dock_msgs
{
  ...
  class UndockFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "fetch_auto_dock_msgs/UndockFeedback"; };

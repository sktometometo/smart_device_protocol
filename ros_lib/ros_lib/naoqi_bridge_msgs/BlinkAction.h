...
namespace naoqi_bridge_msgs
{
  ...
  {
    public:
      typedef naoqi_bridge_msgs::BlinkActionGoal _action_goal_type;
      _action_goal_type action_goal;
      typedef naoqi_bridge_msgs::BlinkActionResult _action_result_type;
      _action_result_type action_result;
      typedef naoqi_bridge_msgs::BlinkActionFeedback _action_feedback_type;

#ifndef _ROS_franka_gripper_MoveResult_h
#define _ROS_franka_gripper_MoveResult_h
...
namespace franka_gripper
{
  ...
  class MoveResult : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "franka_gripper/MoveResult"; };

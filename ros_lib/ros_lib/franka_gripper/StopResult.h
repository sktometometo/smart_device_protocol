#ifndef _ROS_franka_gripper_StopResult_h
#define _ROS_franka_gripper_StopResult_h
...
namespace franka_gripper
{
  ...
  class StopResult : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "franka_gripper/StopResult"; };

#ifndef _ROS_pr2_gripper_sensor_msgs_PR2GripperReleaseData_h
#define _ROS_pr2_gripper_sensor_msgs_PR2GripperReleaseData_h
...
namespace pr2_gripper_sensor_msgs
{
  ...
  class PR2GripperReleaseData : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "pr2_gripper_sensor_msgs/PR2GripperReleaseData"; };

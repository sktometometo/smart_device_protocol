#ifndef _ROS_SERVICE_RosbagRecordRequest_h
#define _ROS_SERVICE_RosbagRecordRequest_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"

namespace rwt_image_view
{

static const char ROSBAGRECORDREQUEST[] = "rwt_image_view/RosbagRecordRequest";

  class RosbagRecordRequestRequest : public ros::Msg
  {
    public:
  ...
  class RosbagRecordRequestResponse : public ros::Msg
  {
    public:
  ...
  class RosbagRecordRequest {
    public:
    typedef RosbagRecordRequestRequest Request;
    typedef RosbagRecordRequestResponse Response;
  };

#ifndef _ROS_SERVICE_MongoQuerywithProjectionMsg_h
#define _ROS_SERVICE_MongoQuerywithProjectionMsg_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char MONGOQUERYWITHPROJECTIONMSG[] = "mongodb_store_msgs/MongoQuerywithProjectionMsg";

  class MongoQuerywithProjectionMsgRequest : public ros::Msg
  {
    public:
    ...
    MongoQuerywithProjectionMsgRequest():
      database(""),
      collection(""),
      type(""),
      single(0),
    ...
    virtual const char * getType() override { return MONGOQUERYWITHPROJECTIONMSG; };
    virtual const char * getMD5() override { return "3dce95387658eb89ce25e603efe525cd"; };

  };

  class MongoQuerywithProjectionMsgResponse : public ros::Msg
  {
    public:
    ...
    MongoQuerywithProjectionMsgResponse():

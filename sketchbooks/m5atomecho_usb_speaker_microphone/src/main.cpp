...
const char *WifiSSID = "sanshiro";
const char *WifiPWD = "ZnkLM2TS9aB4r";
...
void setup() {
  ...
  rest.settoken("4c7525a273f05d23a267367a185a9543");  //<------------------------------------REPLACE YOUR_TOKEN-------------------
}
...
void loop() {
  if (M5.Btn.isPressed()) {
    ...
    if (rest.Pcm2String(microphonedata0, data_offset, DEV_PID_ENGLISH, &SpakeStr) != -1) {
